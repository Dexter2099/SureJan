"""Service layer for the posts app."""

# TODO: module relocated from core.services; core.services remains as shim
...
from core.models import Post, AstroScore, AstroUserSummary
